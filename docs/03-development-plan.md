...
| P1 原型验证 MVP | 3~4 周 | M1：可演示原型 | AC-01~AC-11 全绿，且**每功能均有对应 Git commit** |
| P2 决策与计划调整 | 0.5~1 周 | M2：Go/No-Go | 决策记录归档；正式版范围/排期更新 |
...
> **P0 已于 2025-06 完成**（需求规格 V1.0 冻结，见 `01-requirements.md` §9）；P1 原型开发可随时启动。
